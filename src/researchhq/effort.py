...
PROFILES: dict[str, EffortProfile] = {
    "low": EffortProfile(
        ...
        fetch_top_n=4,
        per_page_chars=2500,
        extractor_max_tokens=900,
        extractor_min_facts=6,
    ...
    "medium": EffortProfile(
        name="medium",
        planner_min_queries=6,
        planner_max_queries=8,
        planner_max_tokens=600,
        results_per_query=6,
        max_total_sources=18,
        fetch_top_n=8,
        per_page_chars=4000,
        extractor_max_tokens=1400,
        extractor_min_facts=12,
        synth_max_tokens=1800,
        synth_depth="balanced",
    ...
    "high": EffortProfile(
        ...
        extractor_min_facts=20,
        synth_max_tokens=3500,
        synth_depth="thorough",
